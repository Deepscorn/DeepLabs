...
namespace UnityThreading
{
    public static class EnumerableExtension
    {
        ...
        {
            return (IEnumerable<Task>)that.ParallelForEach(element => {
                action(element);
                return default(UnityThreading.Task.Unit); }, target);
        }
        ...
        {
            return (IEnumerable<Task>)that.SequentialForEach(element => {
                action(element);
                return default(UnityThreading.Task.Unit); }, target);
        }
